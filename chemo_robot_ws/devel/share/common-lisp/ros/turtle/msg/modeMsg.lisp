...
(cl:defmethod cl:initialize-instance :after ((m <modeMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'modeMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtle-msg:<modeMsg> is deprecated: use turtle-msg:modeMsg instead.")))

(cl:ensure-generic-function 'modeType-val :lambda-list '(m))
(cl:defmethod modeType-val ((m <modeMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle-msg:modeType-val is deprecated.  Use turtle-msg:modeType instead.")
  (modeType m))
